 ...
 *
 * CONFIG_.h - Main CONFIG_uration file
 *
 * This file define the default CONFIG_uration of the copter
...
#define CONFIG_H_
#include <FreeRTOS.h>
#define M2T(X) ((unsigned int)((X)*(CONFIG_TICK_RATE_HZ/1000.0)))
...
//Task stack sizes
#define SYSTEM_TASK_STACKSIZE         (2* CONFIG_MINIMAL_STACK_SIZE)
#define ADC_TASK_STACKSIZE            CONFIG_MINIMAL_STACK_SIZE
#define PM_TASK_STACKSIZE             CONFIG_MINIMAL_STACK_SIZE
#define CRTP_TX_TASK_STACKSIZE        CONFIG_MINIMAL_STACK_SIZE
#define CRTP_RX_TASK_STACKSIZE        CONFIG_MINIMAL_STACK_SIZE
#define CRTP_RXTX_TASK_STACKSIZE      CONFIG_MINIMAL_STACK_SIZE
#define LOG_TASK_STACKSIZE            CONFIG_MINIMAL_STACK_SIZE
#define MEM_TASK_STACKSIZE            CONFIG_MINIMAL_STACK_SIZE
#define PARAM_TASK_STACKSIZE          CONFIG_MINIMAL_STACK_SIZE
#define STABILIZER_TASK_STACKSIZE     (3 * CONFIG_MINIMAL_STACK_SIZE)
#define NRF24LINK_TASK_STACKSIZE      CONFIG_MINIMAL_STACK_SIZE
#define ESKYLINK_TASK_STACKSIZE       CONFIG_MINIMAL_STACK_SIZE
#define SYSLINK_TASK_STACKSIZE        CONFIG_MINIMAL_STACK_SIZE
#define USBLINK_TASK_STACKSIZE        CONFIG_MINIMAL_STACK_SIZE
#define PROXIMITY_TASK_STACKSIZE      CONFIG_MINIMAL_STACK_SIZE
 ...
 * The UART must be CONFIG_ured to run really fast, e.g. in 2Mb/s.
 */
//#define ADC_OUTPUT_RAW_DATA
...
#define F2T(X) ((unsigned int)((CONFIG_TICK_RATE_HZ/(X))))
#include "cfassert.h"
