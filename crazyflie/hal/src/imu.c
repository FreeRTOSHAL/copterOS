...
/*  cosPitch = cosf(configblockGetCalibPitch() * (float) M_PI/180);
  ...
  /* TODO Dyn config */
  cosPitch = cosf(CONFIG_CALLI_PITCH * (float) M_PI/180);
  sinPitch = sinf(CONFIG_CALLI_PITCH * (float) M_PI/180);
  cosRoll = cosf(CONFIG_CALLI_ROLL * (float) M_PI/180);
  sinRoll = sinf(CONFIG_CALLI_ROLL * (float) M_PI/180);
