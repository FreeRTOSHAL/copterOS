...
//  uartInit();
  ...
  if(pass)
  {
    ...
    ledseqRun(LINK_LED, seq_testPassed);*/ /* TODO replace */
  }
  else
  {
    selftestPassed = 0;
    if (systemTest())
    {
      while(1)
      {
        /*ledseqRun(SYS_LED, seq_testPassed);*/ /* TODO replace */ //Red passed == not passed!
        vTaskDelay(M2T(2000));
    ...
    {
      /*ledInit();
      ledSet(SYS_LED, true); */ /* TODO replace */
    }
  }
